...
//         /// <returns></returns>
//         private static SKBitmap GetIcon(string fileName)
//         {
//             if (File.Exists(fileName))
//             {
//                 using (var stream = File.OpenRead(fileName))
//                 {
//                     var skiaImage = SKBitmap.Decode(stream);
//                     var rescaledImage = skiaImage.Resize(new SKImageInfo(16, 16), SKFilterQuality.Medium);
